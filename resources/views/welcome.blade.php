        ...
        <div id="app" class="font-sans bg-grey-lighter flex flex-col min-h-screen w-full">
                ...
                <div class="bg-blue-dark block bg-white border-b">
                    <div class="container mx-auto px-4">
                        ...
                        <div class="flex -mb-px mr-8">
                            <a href="#" class="no-underline text-white text-blue-500 flex items-center py-4 border-b border-blue-dark">
                        ...
                        <div class="flex -mb-px mr-8">
                            <a href="#" class="no-underline text-white opacity-50 text-gray-500 opacity-100 flex items-center py-4 border-b border-transparent hover:opacity-100 md:hover:border-gray-500">
                                <svg class="h-6 w-6 fill-current mr-2" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20">
            ...
            <div class="bg-white border-t">
                <div class="container mx-auto px-4 py-4">
                    <div class="text-gre md:mr-4">&copy; {{ date('Y') }} КВН Статистика</div>
                </div>
            </div>
        </div>
